---
name: hermes-wiki
description: Hermes wiki, hermes wiki, wiki init, wiki add, wiki status. Use ONLY when the user wants Codex to operate a locally installed Hermes Wiki runtime through `hermes wiki ...` commands.
---

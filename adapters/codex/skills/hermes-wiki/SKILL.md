...
hermes wiki get-document-structure --workspace <path> --doc-name <doc> --json
hermes wiki get-page-content --workspace <path> --doc-name <doc> --pages <selector> --json
```
...
- inspect long-document structure with `hermes wiki get-document-structure ... --json` before fetching page text
- fetch only tight page ranges with `hermes wiki get-page-content ... --pages 5-8 --json`
